            ...
            <div className="navbar bg-[#f9f7f2 font-primary text-white bg-[#faf7f2] bg-[#f9ede8">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
                            <li> <NavLink to='/' className={({ isActive }) => isActive ? 'rounded bg-[#b18b5e] text-lg font-bold  ' : 'text-black font-semibold'}>
                ...
                <div className="navbar-center hidden lg:flex">
                    <ul className="menu menu-horizontal px-1">
                        <li> <NavLink to='/' className={({ isActive }) => isActive ? 'rounded bg-[#b18b5e]  font-bold' : 'text-black border border-[#b18b5e] font-semibold'}>
                    ...
                    {user ?
                        ...
                        <div className="">
                            ...
                            <div className="dropdown dropdown-bottom dropdown-hover dropdown-end text-black z-10">
                                ...
                                <ul tabIndex={0} className="dropdown-content text-base font-bold text-white bg-[#b18b5e] z-[1] menu  shadow rounded w-[200px]">
                        ...
                        <div>
                            <Link to={'/register'}> <button className="py-1 text-xl sm:py-2 px-3 sm:h-[44px] font-bold rounded bg-[#b18b5e] btn  sm:text-lg text-white">Registration</button></Link>
                            <Link to={'/login'}> <button className="py-1  text-lg sm:py-2 px-3 sm:h-[44px] font-bold rounded bg-[#b18b5e] btn  sm:text-lg text-white">Login</button></Link>
                        </div>
                    }
                </div>
            </div>
